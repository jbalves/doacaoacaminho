...
- (void)viewDidLoad
{
    ...
    institutions = [[NSMutableArray alloc] initWithArray:[[InstitutionStore sharedStore] getAllInstitutions]];
    
    for(NSObject *inst in institutions) {
        MKPointAnnotation *annotation = [[MKPointAnnotation alloc] init];
        annotation.coordinate = CLLocationCoordinate2DMake([[inst valueForKey:@"latitude"] doubleValue], [[inst valueForKey:@"longitude"] doubleValue]);
        annotation.title = (NSString*)[inst valueForKey:@"name"];
